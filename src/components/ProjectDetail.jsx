...
import {
  ArrowLeft, ExternalLink, Github, Code2, Star, Download,
  ...
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
      <div className="relative mt-2">
        <div className="relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-white group-hover:scale-125 transition-transform duration-300" />
      </div>
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-white/[0.02] rounded-xl overflow-hidden relative border border-white/5">
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-white/10 transition-all duration-300 hover:scale-105 hover:border-white/30 hover:shadow-lg">
        <div className="bg-white/10 p-1.5 md:p-2 rounded-full">
          <Code2 className="text-white w-4 h-4 md:w-6 md:h-6" strokeWidth={1.5} />
        </div>
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-white/10 transition-all duration-300 hover:scale-105 hover:border-white/30 hover:shadow-lg">
        <div className="bg-white/10 p-1.5 md:p-2 rounded-full">
          <Layers className="text-white w-4 h-4 md:w-6 md:h-6" strokeWidth={1.5} />
        </div>
        <div className="flex-grow">
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center space-y-6 animate-fadeIn">
          <div className="w-16 h-16 md:w-24 md:h-24 mx-auto border-4 border-white/20 border-t-white rounded-full animate-spin" />
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent leading-tight">
                  {project.Title}
                </h1>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                {/* Primary action: Download APK for Android apps, else Live Demo for web */}
                {project.ApkLink ? (
                  <a
                    href={project.ApkLink}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-white text-black hover:bg-gray-200 rounded-xl transition-all duration-300 overflow-hidden text-sm md:text-base font-medium"
                  >
                    <Download className="relative w-4 h-4 md:w-5 md:h-5 group-hover:translate-y-0.5 transition-transform" />
                    <span className="relative font-medium">Download APK</span>
                  </a>
                ) : project.Link ? (
                  <a
                    href={project.Link}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-white/5 hover:bg-white/10 text-white rounded-xl transition-all duration-300 border border-white/10 hover:border-white/30 backdrop-blur-xl overflow-hidden text-sm md:text-base"
